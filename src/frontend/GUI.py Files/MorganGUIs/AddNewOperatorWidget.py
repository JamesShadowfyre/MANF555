...
class Ui_addNewOperatorWidget(object):
    def setupUi(self, addNewOperatorWidget):
        ...
        self.saveOperatorButton = QtWidgets.QPushButton(parent=addNewOperatorWidget)
        self.saveOperatorButton.setGeometry(QtCore.QRect(130, 120, 131, 24))
        self.saveOperatorButton.setObjectName("saveOperatorButton")
        self.groupBox = QtWidgets.QGroupBox(parent=addNewOperatorWidget)
