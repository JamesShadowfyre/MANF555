...
class Ui_ExecuteProduction(object):
    ...
    def retranslateUi(self, ExecuteProduction):
        ...
        self.executeWODrillingArrangementSelection.setItemText(1, _translate("ExecuteProduction", "None"))
        self.executeWODrillingArrangementSelection.setItemText(2, _translate("ExecuteProduction", "Left"))
        self.executeWODrillingArrangementSelection.setItemText(3, _translate("ExecuteProduction", "Right"))
        self.executeWODrillingArrangementSelection.setItemText(4, _translate("ExecuteProduction", "Both"))
