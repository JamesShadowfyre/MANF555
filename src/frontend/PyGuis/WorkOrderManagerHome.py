...
class Ui_WorkOrderManagerWidget(object):
    def setupUi(self, WorkOrderManagerWidget):
        ...
        WorkOrderManagerWidget.resize(1058, 379)
        self.groupBox_2 = QtWidgets.QGroupBox(WorkOrderManagerWidget)
        self.groupBox_2.setGeometry(QtCore.QRect(30, 110, 851, 241))
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 10, 851, 71))
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 841, 51))
        ...
        self.RefreshData = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.RefreshData.setObjectName("RefreshData")
        self.horizontalLayout.addWidget(self.RefreshData)
        self.label = QtWidgets.QLabel(WorkOrderManagerWidget)
        self.label.setGeometry(QtCore.QRect(30, 90, 831, 16))
    ...
    def retranslateUi(self, WorkOrderManagerWidget):
        ...
        self.RefreshData.setText(_translate("WorkOrderManagerWidget", "Refresh Data"))
        self.label.setText(_translate("WorkOrderManagerWidget", "Note: Update the screen after creating, editing, or deleting work order information by clicking the \"Refresh Data\" button"))
